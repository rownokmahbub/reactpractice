  ...
  return (
    <div className='w-full h-screen duration-300' style={{backgroundColor: color}}>
        ...
        <div className="flex justify-center gap-3 shadow-xl bg-white px-10 py-4 rounded-full">
            ...
            <button onClick={()=> setColor('white')} className='outline-none px-4 py-2 rounded-full text-black shadow-xl focus:ring-4 ring-white-300' style={{backgroundColor : "white"}}>White</button>
            <button onClick={()=> setColor('black')} className='outline-none px-4 py-2 rounded-full text-white shadow-xl focus:ring-4 ring-black-300' style={{backgroundColor : "black"}}>Black</button>
        </div>
        </div>
    </div>
  )
